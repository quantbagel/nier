# VPC Module for Nier Factory Floor Analytics Platform
# Provides secure networking infrastructure with public/private subnets
...
# Private Subnets - for EKS nodes, RDS, MSK, GPU instances
